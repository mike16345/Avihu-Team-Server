  ...
  constructor(){
   ...
   addDietPlan = async (event: APIGatewayProxyEvent): Promise<APIGatewayProxyResult> => {
    ...
    try {
      ...
      return this.successResponse({status:StatusCode.CREATED,data:dietPlanResult,message:"Successfully added diet plan!"})
   ...
   updateDietPlan = async (event: APIGatewayProxyEvent): Promise<APIGatewayProxyResult> => {
    ...
    try {
      ...
      return this.successResponse({status:StatusCode.OK,data:updatedDietPlan,message: "Successfully updated diet plan!"})
   ...
   updateDietPlanByUserId = async (
    ...
    try {
      ...
      return this.successResponse({status:StatusCode.OK,data:updatedDietPlan,message: "Successfully updated diet plan by user ID!"})
...
return this.successResponse({status:StatusCode.OK,data:response,message:  "Successfully deleted diet plan by user ID!"})
    } catch (err: any) {
      return this.errorResponse(err)
    }
  };
   ...
   getDietPlanById = async (event: APIGatewayProxyEvent): Promise<APIGatewayProxyResult> => {
    ...
    try {
      ...
      return this.successResponse({status:StatusCode.OK,data:dietPlan,message: "Successfully retrieved diet plan!"})
    } catch (err: any) {
      return this.errorResponse(err)
    }
  };

   getDietPlanByUserId = async (
    event: APIGatewayProxyEvent
  ): Promise<APIGatewayProxyResult> => {
    const populate = event.queryStringParameters?.populate;
    ...
    try {
      ...
      return this.successResponse({status:StatusCode.OK,data:dietPlan,message: "Successfully retrieved diet plan by user ID!"})
